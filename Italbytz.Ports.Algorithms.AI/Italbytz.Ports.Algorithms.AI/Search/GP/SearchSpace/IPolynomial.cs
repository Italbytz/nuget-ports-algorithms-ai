...
/// <summary>
/// Represents a polynomial expression in genetic programming for search algorithms.
/// </summary>
...
public interface IPolynomial<TCategory> : ICloneable
{
    ...
    /// <summary>
    /// Gets the size of the polynomial, typically the number of different literals.
    /// </summary>
    int Size { get; }
