...
/// </summary>
/// <remarks>
/// Fitness functions evaluate individuals in a population against a dataset to determine 
...
public interface IFitnessFunction
{
    ...
    /// <summary>
    /// Gets or sets the name of the column in the data containing the target values (labels).
    /// </summary>
