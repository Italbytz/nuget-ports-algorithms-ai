...
/// </summary>
/// <remarks>
/// An individual contains a genotype and fitness information, and can be compared with other
...
public interface IIndividual : ICloneable
{
    ...
    /// <summary>
    /// Gets or sets the generation number in which this individual was created or last modified.
    /// </summary>
    int Generation { get; set; }

    /// <summary>
    /// Determines whether this individual dominates another individual in terms of fitness.
    /// This is typically used in multi-objective optimization where an individual dominates
    /// another if it is at least as good in all objectives and better in at least one.
    /// </summary>
    /// <param name="otherIndividual">The individual to compare with.</param>
    /// <returns>True if this individual dominates the other individual; otherwise, false.</returns>
